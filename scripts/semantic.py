...
CONCEPTS: list[dict[str, Any]] = [
    ...
    {"say": ["recreation", "rec", "recreation management", "rec management",
             ...
             "class registration", "registration", "rec center",
             "community center", "memberships", "membership", "ymca"],
     "go": [["Parks & Rec", "Recreation Management"]]},
    {"say": ["camp", "camps", "camping", "summer camp", "day camp"],
     "go": [["Parks & Rec", "Camps & Youth Programs"]]},
    {"say": ["facility booking", "facility reservation", "facility reservations",
             "room booking", "desk booking", "staff scheduling", "shift scheduling"],
     "go": [["Parks & Rec", "Facility Booking & Workforce"]]},
    ...
    {"say": ["trails", "trail", "playground", "playgrounds",
             "park operations", "park maintenance",
             "splash pad", "ranger", "rangers",
             "tree inventory", "urban forestry"],
     "go": [["Parks & Rec", "Park Assets, Forestry & Visitor Data"]]},
    {"say": ["irrigation", "turf", "grounds", "landscaping", "mowing",
             "sprinkler", "sprinklers"],
     "go": [["Parks & Rec", "Grounds, Irrigation & Turf"]]},
    {"say": ["lightning", "weather station", "heat index", "wbgt"],
     "go": [["Parks & Rec", "Weather & Outdoor Safety"]]},
    {"say": ["pool", "pools", "aquatic", "aquatics", "swim", "swimming",
             "lifeguard", "lifeguards", "drowning"],
     "go": [["Parks & Rec", "Aquatics"]]},
    {"say": ["campground", "campgrounds", "campsite", "campsites",
             "reservations", "rv park"],
     "go": [["Parks & Rec", "Outdoor Rec & Reservations"]]},
    {"say": ["background check", "background checks",
             "safesport", "abuse prevention", "volunteer screening"],
     "go": [["Parks & Rec", "Screening, Safety & Compliance"]]},
    {"say": ["volunteer", "volunteers", "volunteering"],
     "go": [["Parks & Rec", "Volunteer Management"]]},
    {"say": ["tourism", "destination", "destinations", "visitor", "visitors",
             "dmo", "attractions"],
     "go": [["Parks & Rec", "Destination Marketing & Tourism"]]},
    {"say": ["events", "event", "convention", "conventions", "festival",
             "festivals", "venue", "venues"],
     "go": [["Parks & Rec", "Events, Venues & Ticketing"]]},
